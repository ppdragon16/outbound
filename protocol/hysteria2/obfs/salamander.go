 ...
 *
 * Salamander packet obfuscation for Hysteria2, ported from
 * github.com/apernet/hysteria (extras/obfs/salamander.go), AGPL-3.0.
 *
 * Wire format per packet: [8-byte random salt][payload XOR BLAKE2b-256(PSK || salt)]
 */
...
// pre-shared key combined with a random salt.
