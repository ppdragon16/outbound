...
func TestUDPMessage(t *testing.T) {
	t.Run("buffer too small", func(t *testing.T) {
		...
		if (&UDPMessage{
			...
			FragID:    2,
			FragCount: 5,
			AddrPort:  netip.MustParseAddrPort("1.2.3.4:80"),
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []byte{0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x0, 0x1, 0xe, 0x31, 0x39, 0x32, 0x2e, 0x31, 0x36, 0x38, 0x2e, 0x31, 0x2e, 0x31, 0x3a, 0x38, 0x30, 0x47, 0x45, 0x54, 0x20, 0x2f, 0x6e, 0x6f, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x20, 0x48, 0x54, 0x54, 0x50, 0x2f, 0x31, 0x2e, 0x31, 0xd, 0xa},
		},
		{
			name: "ipv6",
			fields: fields{
				SessionID: 1329655244,
				AddrPort:  netip.MustParseAddrPort("[2001:db8:85a3::8a2e:370:7334]:9000"),
				PacketID:  62233,
				FragID:    8,
				FragCount: 19,
				Data:      []byte("God is great, beer is good, and people are crazy."),
			},
			want: []byte{0x4f, 0x40, 0xed, 0xcc, 0xf3, 0x19, 0x8, 0x13, 0x23, 0x5b, 0x32, 0x30, 0x30, 0x31, 0x3a, 0x64, 0x62, 0x38, 0x3a, 0x38, 0x35, 0x61, 0x33, 0x3a, 0x3a, 0x38, 0x61, 0x32, 0x65, 0x3a, 0x33, 0x37, 0x30, 0x3a, 0x37, 0x33, 0x33, 0x34, 0x5d, 0x3a, 0x39, 0x30, 0x30, 0x30, 0x47, 0x6f, 0x64, 0x20, 0x69, 0x73, 0x20, 0x67, 0x72, 0x65, 0x61, 0x74, 0x2c, 0x20, 0x62, 0x65, 0x65, 0x72, 0x20, 0x69, 0x73, 0x20, 0x67, 0x6f, 0x6f, 0x64, 0x2c, 0x20, 0x61, 0x6e, 0x64, 0x20, 0x70, 0x65, 0x6f, 0x70, 0x6c, 0x65, 0x20, 0x61, 0x72, 0x65, 0x20, 0x63, 0x72, 0x61, 0x7a, 0x79, 0x2e},
		},
	}
