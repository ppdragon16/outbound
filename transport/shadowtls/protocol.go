// Package shadowtls implements the ShadowTLS v3 client protocol.
//
// Ported from mihomo/transport/shadowtls (MIT, upstream project:
// github.com/ihciah/shadow-tls), adapted to this codebase's dependency
// set: metacubex/tls (session-id hook) -> refraction-networking/utls
// public ClientHello mutation API.
package shadowtls
...
// User is a ShadowTLS authentication credential.
type User struct {
	Name     string
	Password string
}
